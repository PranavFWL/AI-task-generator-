...
exports.AIAgentSystem = void 0;
const AICoordinatorAgent_1 = require("./agents/AICoordinatorAgent");
const CoordinatorAgent_1 = require("./agents/CoordinatorAgent");
class AIAgentSystem {
    constructor(useAI = true) {
        this.useAI = useAI;
        this.aiCoordinator = new AICoordinatorAgent_1.AICoordinatorAgent();
        this.fallbackCoordinator = new CoordinatorAgent_1.CoordinatorAgent();
    }
    async processProject(brief) {
    ...
    async processWithFallback(brief) {
    ...
    async executeSpecificTasks(tasks) {
...
exports.AIAgentSystem = AIAgentSystem;
//# sourceMappingURL=AIAgentSystem.js.map